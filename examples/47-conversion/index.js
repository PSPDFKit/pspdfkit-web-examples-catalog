...
export function load(_defaultConfiguration) {
  ...
  if (
    ...
    if (forcedProcessorEngine === "smallerSize") {
      defaultConfiguration.processorEngine = PSPDFKit.ProcessorEngine.smallerSize;
    } else if (forcedProcessorEngine === "fasterProcessing") {
      defaultConfiguration.processorEngine = PSPDFKit.ProcessorEngine.fasterProcessing;
    } else {
      console.warn(`processorEngine query value '${forcedProcessorEngine}' is unknown.`);
    }
  }
    ...
    <div className="customContainer">
      <>
        <div className="topBar">
          ...
          {!isServer && defaultConfiguration && <p>Processor Engine: {defaultConfiguration.processorEngine}</p>}
        </div>
