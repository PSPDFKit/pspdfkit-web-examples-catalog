...
// toolbars.
//
// https://web-examples.services.demo.pspdfkit.com/tooltips
...
function registerIsDragAndResizeDetector() {
  ...
  function trackMouseMove(event) {
    ...
    instance.contentDocument
      .querySelector(".PSPDFKit-Root")
      .setAttribute("data-is-dragging-or-resizing", "true");
  }
  ...
  instance.contentDocument.addEventListener(
    ...
    function (event) {
      if (
        svgElementHasClass(event.target, "PSPDFKit-Selection-Outline-Border")
      ) {
      ...
      instance.contentDocument.addEventListener("mousemove", trackMouseMove, {
        capture: true,
      });
      ...
      instance.contentDocument.addEventListener(
        ...
        function () {
          ...
          instance.contentDocument
            .querySelector(".PSPDFKit-Root")
            .removeAttribute("data-is-dragging-or-resizing", "true");
