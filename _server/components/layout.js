...
export default class Layout extends React.Component {
  ...
  render() {
    ...
    const exampleTitle = !["custom", "upload", "404"].includes(currentExample)
    ...
    return (
      <div className="layout" onClick={this._handleLayoutClick}>
        <header className="header">
          ...
          <div className="header__product header__whats-new">Web Examples</div>
          <a
          ...
          <div className="header__ctas header__ctas--inline">
            ...
            <a
              ...
              target="_blank"
              href="https://www.nutrient.io/contact-sales?=sdk"
            >
              Contact Sales
            </a>
          </div>
...
/**
 * Show the 'Nutrient Web SDK' version number in the header as a link to the
 * release changelog.
 *
 * Note: This presumes the changelog URLs follow the format:
 *
 * https://www.nutrient.io/changelog/web/#<VERSION>
 *
 * Example: https://www.nutrient.io/changelog/web/#2020.5.0
 */
function changelogUrlForVersion(version) {
  if (version) {
    return `https://www.nutrient.io/changelog/web/#${version}`;
  } else {
    return null;
  }
}
